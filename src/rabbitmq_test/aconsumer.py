...
class Consumer(object):
    ...
    EXCHANGE = 'message'
    EXCHANGE_TYPE = 'topic'
#     QUEUE = 'text'  # !! We don't hard-code the name of the queue.
    ...
    def __init__(self, amqp_url):
        ...
        # !! The following six object data members are new.
        self._queue = None
        ...
        self._acknowledge_messages = True  # Whether to send ack upon receiving message

    # !! The following four methods are new
    def set_acknowledge_messages(self, true_or_false) :
        """When set to True, messages are acknowledged after reading.
        When set to False, no acknowledgment is sent.
        """
        self._acknowledge_messages = true_or_false
    ...
    def set_message_count_limit(self, message_count_limit) :
    ...
    def on_connection_error(self, unused_connection, message):   # !! New method
    ...
    def on_message(self, unused_channel, basic_deliver, properties, body):
        ...
        # !! In the original example, the message is simply logged.
        # LOGGER.info('Received message # %s from %s: %s',
        #             basic_deliver.delivery_tag, properties.app_id, body)

        num = self._on_message_callback(unused_channel, basic_deliver, properties, body)
        if self._acknowledge_messages :
        ...
        if self._message_count_limit > 0 and self._message_count >= self._message_count_limit :
